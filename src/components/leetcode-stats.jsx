...
function LeetCodeStats() {
  return (
    <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-lg shadow-2xl border-2 border-gray-900">
    <div  className=" w-[400px] mx-auto" >
      <h2 className="text-[30px] font-extrabold bg-gradient-to-r from-orange-400 via-yellow-400 to-red-500 bg-clip-text text-transparent tracking-tight">LeetCode Progress</h2>
<br></br>
        <div className="grid grid-cols-2 gap-4 text-center mb-6">
    <div className="p-4 rounded-xl bg-gray-800 border border-white/10">
      <p className="text-3xl font-bold text-orange-400">255</p>
      <p className="text-sm text-gray-300">Total Solved</p>
    </div>

    <div className="p-4 rounded-xl bg-gray-800 border border-white/10">
      <p className="text-3xl font-bold text-purple-400">46%</p>
      <p className="text-sm text-gray-300">Acceptance Rate</p>
    </div>
  </div>
  ...
  <div className="text-center border-t border-white/10 pt-4 mb-4">
    ...
    <p className="text-sm text-gray-300">Global Ranking</p>
  </div>

  {/* Profile Link */}
  <div className="text-center">
    <a
      href="https://leetcode.com/u/prabhleenkaur11/"
           className="inline-block px-6 py-3 rounded-lg font-semibold text-white bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-400 hover:to-red-400 transition-all shadow-lg"
    >
